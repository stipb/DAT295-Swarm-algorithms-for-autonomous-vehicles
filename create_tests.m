...
init_x_position = [100 120 40];
init_y_position = [26 26 24];

init_vel = [50 52 55]./3.6; % Initial velocity for vehicles
init_ang = [0 0 0]; % Starting angle for vehicles

lane = [1 2 1]; % Which lane the vehicles should drive in
init_conn = [false true true ]; % Set if vehicles should have communcation enabled
